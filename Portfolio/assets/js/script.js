...
function validateForm() {
    if (!validateName() || !validateEmail() || !validateMessage()) {
        alert('Please fill all fields correctly and submit');
...
document.getElementById("resumebutton").addEventListener("click", function() {
    const fileUrl = '/assets/images/Muhammad-Noushal-CV.pdf';
    const a = document.createElement("a");
    a.href = fileUrl;
    a.download = 'Muhammad-Noushal-CV.pdf';
...
var typed = new Typed(".typing-text", {
    strings: ["Game Development in Unity", "Game Development in UnReal", "Game Designing", "web designing", "web development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function showProjects(projects) {
    ...
    projects.slice(0, 10).filter(project => project.category != "android").forEach(project => {
        projectHTML += `
        <div class="box tilt">
      <img draggable="false" src="assets/images/projects/${project.image}.avif">
      <div class="content">
        <div class="tag">
        <h3>${project.name}</h3>
        </div>
